...
//{/if}//
     ...
     */
    ui.Nselect = core.inherits(
        ui.InputControl,
        'ui-nselect',
        function (el, options) {
            var optionsEl = dom.getElementsByClassName(el,"select-list")[0];
            util.setDefault(options, 'hidden', true);

            ui.InputControl.constructor.call(this, el, options);

            this._uText = core.$fastCreate(ui.Item, dom.getElementsByClassName(el,"textlike")[0], this, {capturable: false});
